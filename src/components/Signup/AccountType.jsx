    ...
    <SplitLayout>
        <article className={`w-full md:p-10 lg:shadow-lg globe-bg`}>
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-8 lg:gap-20 w-full justify-between mt-16">
              <Link to={'individual'} className="w-full flex flex-col items-center justify-center gap-5 p-6 rounded-xl bg-white shadow-md">
              ...
              <Link to={'organization'} className="w-full flex flex-col items-center justify-center gap-5 p-6 rounded-xl bg-white shadow-md">
