...
export default function SplitLayout({ img, heading, children }) {
	...
	return (
		<section
			className={`w-full h-full relative justify-between items-stretch text-black mt-10 grid grid-cols-1 lg:grid-cols-2 lg:gap-10 lg:pr-10 min-h-screen lg:m-0 font-nunito`}
		>
